...
# Some Next setups may map differently; also try the explicit route without parentheses:
$otpUri2 = "http://localhost:3000/api/admin/verify-otp"
...
Invoke-FuzzPost -uri $otpUri2 -body "{""email"":""test@example.com"",""otp"":""123456""}"
