...
export class OrderService {
  // Get all orders
  static async getAllOrders(filters: Record<string, any> = {}, pagination: Record<string, any> = {}) {
  ...
  // Get order by ID
  static async getOrderById(orderId: any) {
  ...
  // Create order
  static async createOrder(data: any, createdByUserId: any) {
    const {
      reference,
      customerId,
      rfqId,
  ...
  // Update order
  static async updateOrder(orderId: any, data: any) {
    const {
      customerId,
      rfqId,
      subtotal,
  ...
  // Update order status
  static async updateOrderStatus(orderId: any, status: any) {
    return await prisma.order.update({
      where: { id: orderId },
  ...
  // Cancel order
  static async cancelOrder(orderId: any) {
    return await prisma.order.update({
      where: { id: orderId },
  ...
  // Complete order
  static async completeOrder(orderId: any) {
    return await prisma.order.update({
      where: { id: orderId },
