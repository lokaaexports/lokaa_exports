...
export class TemplateService {
  ...
  static async getTemplatesByCategory(categoryId: any) {
    try {
      return await prisma.productTemplate.findMany({
  ...
  static async getTemplatesBySubcategory(subcategoryId: any) {
    try {
      return await prisma.productTemplate.findMany({
  ...
  static async updateTemplate(templateId: any, data: any) {
    try {
  ...
  static async deleteTemplate(templateId: any) {
    try {
  ...
  static async addTemplateField(templateId: any, fieldData: any) {
    try {
  ...
  static async updateTemplateField(fieldId: any, fieldData: any) {
    try {
  ...
  static async deleteTemplateField(fieldId: any) {
    try {
  ...
  static async reorderTemplateFields(templateId: any, fieldOrder: any) {
    try {
  ...
  static async getTemplateFormSchema(templateId: any) {
    try {
      const template = await prisma.productTemplate.findUnique({
        where: { id: templateId },
        include: {
      ...
      const schema = {
        ...
        fields: template.fields.map(field => ({
          ...
          help: field.helpText,
          validation: typeof field.validationRules === 'string'
             ? (() => { try { return JSON.parse(field.validationRules) } catch { return null } })()
  ...
  static async createPredefinedTemplates(categoryId: any) {
    const templates = {
