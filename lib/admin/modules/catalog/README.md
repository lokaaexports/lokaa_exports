...
|--------|----------|-------------|
| GET | `/api/admin/catalog/products` | List all products |
...
| GET | `/api/admin/catalog/products?action=stats` | Get statistics |
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/api/admin/catalog/templates?categoryId=...` | Get category templates |
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/api/admin/catalog/specifications?productId=...` | List specifications |
