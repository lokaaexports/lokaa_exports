...
- `PUT /api/admin/products-advanced/categories?id=...`
- `DELETE /api/admin/products-advanced/categories?id=...`
...
- `POST /api/admin/products-advanced/products?action=publish`
...
- [ ] Seed database: `node lib/admin/modules/products-advanced/seeds/seed-products.js`
...
**All files located in**: `lib/admin/modules/products-advanced/`
...
// 4. Upload images
await fetch('/api/admin/products-advanced/images', {
  method: 'POST',
  body: JSON.stringify({
    productId: product.id,
...
await fetch('/api/admin/products-advanced/export-info', {
  method: 'POST',
  body: JSON.stringify({
    productId: product.id,
