...
- `GET /api/admin/products-advanced/products?action=stats` - Product statistics
...
#### Subcategories
- `GET /api/admin/products-advanced/subcategories?categoryId=...` - List subcategories
- `POST /api/admin/products-advanced/subcategories` - Create subcategory

#### Templates
- `GET /api/admin/products-advanced/templates?categoryId=...` - Get templates by category
...
#### Specifications
- `GET /api/admin/products-advanced/specifications?productId=...` - List specs
...
#### Images
- `GET /api/admin/products-advanced/images?productId=...` - List images
- `POST /api/admin/products-advanced/images` - Add image
- `PUT /api/admin/products-advanced/images/:id` - Update image
- `DELETE /api/admin/products-advanced/images/:id` - Delete image

#### Packaging
- `GET /api/admin/products-advanced/packaging?productId=...` - List packaging
- `POST /api/admin/products-advanced/packaging` - Add packaging
- `PUT /api/admin/products-advanced/packaging/:id` - Update packaging
- `DELETE /api/admin/products-advanced/packaging/:id` - Delete packaging

#### Certifications
- `GET /api/admin/products-advanced/certifications?productId=...` - List certifications
- `POST /api/admin/products-advanced/certifications` - Add certification
- `PUT /api/admin/products-advanced/certifications/:id` - Update certification
- `DELETE /api/admin/products-advanced/certifications/:id` - Delete certification

#### SEO
- `GET /api/admin/products-advanced/seo?productId=...` - Get SEO data
- `POST /api/admin/products-advanced/seo` - Create/Update SEO
- `PUT /api/admin/products-advanced/seo?productId=...` - Update SEO

#### Export Info
- `GET /api/admin/products-advanced/export-info?productId=...` - Get export info
- `POST /api/admin/products-advanced/export-info` - Create/Update export info
- `PUT /api/admin/products-advanced/export-info?productId=...` - Update export info

#### RFQ Enquiries
- `GET /api/admin/products-advanced/rfq-enquiries?productId=...` - List enquiries
- `POST /api/admin/products-advanced/rfq-enquiries` - Create enquiry (public)
- `PUT /api/admin/products-advanced/rfq-enquiries/:id/status` - Update status
...
components/admin/products-advanced/
├── ProductForm.jsx
...
3. ⏳ API routes (create in app/api/admin/products-advanced/)
