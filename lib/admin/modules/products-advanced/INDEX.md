...
7. **[COMPONENTS.md](../../../components/admin/products-advanced/COMPONENTS.md)**
...
│           - Seed command: node -r dotenv/config lib/admin/modules/products-advanced/seeds/seed-products.js
│
...
### Step 3: Build UI
- Import components from `components/admin/products-advanced/`
...
| "I want to use the components" | [COMPONENTS.md](../../../components/admin/products-advanced/COMPONENTS.md) |
