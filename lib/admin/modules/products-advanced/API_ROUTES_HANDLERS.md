...
// Location: app/api/admin/products-advanced/
...
import {
  ...
  RFQEnquiryService
} from '@/lib/admin/modules/products-advanced/services/product-features.service'

// ===== PRODUCTS ROUTES =====

export async function handleProductsRoute(method, body, query, session) {
  if (method === 'GET') {
    // GET /api/admin/products-advanced/products
    const filters = {
  ...
  if (method === 'POST') {
    // POST /api/admin/products-advanced/products
  ...
  if (method === 'PUT') {
    // PUT /api/admin/products-advanced/products/:id
  ...
  if (method === 'DELETE') {
    // DELETE /api/admin/products-advanced/products/:id
...
export async function handleCategoriesRoute(method, body, query, session) {
  if (method === 'GET') {
    // GET /api/admin/products-advanced/categories
    const categories = await CategoryService.getAllCategories()
    return { status: 200, data: categories }
  }

  if (method === 'POST') {
    // POST /api/admin/products-advanced/categories
...
export async function handleTemplatesRoute(method, body, query, session) {
  if (method === 'GET') {
    // GET /api/admin/products-advanced/templates
    if (query.categoryId) {
  ...
  if (method === 'POST') {
    // POST /api/admin/products-advanced/templates
...
export async function handleSpecificationsRoute(method, body, query, session) {
  ...
  if (method === 'PUT') {
    // PUT /api/admin/products-advanced/specifications/:id
  ...
  if (method === 'DELETE') {
    // DELETE /api/admin/products-advanced/specifications/:id
...
export async function handleImagesRoute(method, body, query, session) {
  ...
  if (method === 'PUT') {
    // PUT /api/admin/products-advanced/images/:id
  ...
  if (method === 'DELETE') {
    // DELETE /api/admin/products-advanced/images/:id
...
export async function handlePackagingRoute(method, body, query, session) {
  ...
  if (method === 'PUT') {
    // PUT /api/admin/products-advanced/packaging/:id
  ...
  if (method === 'DELETE') {
    // DELETE /api/admin/products-advanced/packaging/:id
...
export async function handleSEORoute(method, body, query, session) {
  ...
  if (method === 'PUT') {
    // PUT /api/admin/products-advanced/seo?productId=...
...
export async function handleExportInfoRoute(method, body, query, session) {
  if (method === 'GET') {
    // GET /api/admin/products-advanced/export-info?productId=...
    const info = await ExportInfoService.getExportInfo(query.productId)
    return { status: 200, data: info }
  }

  if (method === 'POST') {
    // POST /api/admin/products-advanced/export-info
  ...
  if (method === 'PUT') {
    // PUT /api/admin/products-advanced/export-info?productId=...
...
export async function handleRFQEnquiryRoute(method, body, query, session) {
  if (method === 'GET') {
    // GET /api/admin/products-advanced/rfq-enquiries?productId=...
    const enquiries = await RFQEnquiryService.getProductEnquiries(query.productId)
    return { status: 200, data: enquiries }
  }

  if (method === 'POST') {
    // POST /api/admin/products-advanced/rfq-enquiries (Public)
  ...
  if (method === 'PUT') {
    // PUT /api/admin/products-advanced/rfq-enquiries/:id/status
...
export async function handleProductActionsRoute(method, body, query, session) {
  ...
  if (action === 'publish') {
    // POST /api/admin/products-advanced/products/:id?action=publish
  ...
  if (action === 'duplicate') {
    // POST /api/admin/products-advanced/products/:id?action=duplicate
  ...
  if (action === 'bulk-update-status') {
    // POST /api/admin/products-advanced/products?action=bulk-update-status
  ...
  if (action === 'bulk-delete') {
    // DELETE /api/admin/products-advanced/products?action=bulk-delete
  ...
  if (action === 'search') {
    // GET /api/admin/products-advanced/products?action=search&q=...
    const products = await ProductService.searchProducts(query.q, 20)
    return { status: 200, data: products }
  }

  if (action === 'stats') {
    // GET /api/admin/products-advanced/products?action=stats
