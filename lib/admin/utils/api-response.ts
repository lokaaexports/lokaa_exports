...
export class ApiResponse {
  static success(data: any, message = null, status = 200) {
  ...
  static error(error: any, status = 500, message = null) {
  ...
  static paginated(data: any, total: any, page: any, pageSize: any, message = null) {
    return NextResponse.json(
      {
        success: true,
        data,
 ...
 */
export function logAdminRequest(method: any, path: any, userId: any, details = {}) {
 ...
 */
export async function handleApiError(handler: any) {
