...
function normalizePrismaProductRow(row) {
  return {
    id: row.id,
    slug: row.slug,
...
function normalizePrismaCategoryRow(row) {
  return {
    id: row.id,
    slug: row.slug,
    name: row.name,
...
export class ProductService {
  ...
  async updateBySlug(slug, product) {
...
export class CategoryService {
  ...
  async updateBySlug(slug, category) {
