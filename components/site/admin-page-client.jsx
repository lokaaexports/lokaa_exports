...
function ProductsTab({ catalog, updateEntity, addEntity, activeItem, setActiveItem }) {
...
function CategoriesTab({ catalog, updateEntity, addEntity, removeEntity, activeItem, setActiveItem }) {
...
function SubcategoriesTab({ catalog, updateEntity, addEntity, removeEntity, activeItem, setActiveItem }) {
...
function AttributesTab({ catalog, updateEntity, addEntity, removeEntity, activeItem, setActiveItem }) {
...
function PackagingTab({ catalog, updateEntity, addEntity, removeEntity, activeItem, setActiveItem }) {
...
function CountriesTab({ catalog, updateEntity, addEntity, removeEntity, activeItem, setActiveItem }) {
