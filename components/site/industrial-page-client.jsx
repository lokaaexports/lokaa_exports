...
export default function IndustrialPageClient() {
  const machinery = [
    { title: 'Food Processing Machinery', description: 'Milling, blending, grading, oil extraction and packaging lines for food and agro-processing plants.', image: 'https://images.unsplash.com/photo-1565043666747-69f6646db940?auto=format&fit=crop&w=1400&q=80', metrics: ['OEM sourcing', 'CE-ready options', 'Custom skid designs'] },
    { title: 'Packaging & Converting Equipment', description: 'Filling, sealing, conveying and carton handling systems for high-throughput packaging operations.', image: 'https://images.unsplash.com/photo-1581092334467-4c46d2e13c02?auto=format&fit=crop&w=1400&q=80', metrics: ['Fast lead times', 'Spare parts support', 'Multi-country shipping'] },
    { title: 'Automation & Electrical Systems', description: 'Panels, sensors, drives, PLCs and machine controls for modern production facilities.', image: 'https://images.unsplash.com/photo-1581093458791-9d42f7ce17f5?auto=format&fit=crop&w=1400&q=80', metrics: ['PLC / HMI support', 'Commissioning support', 'Technical documentation'] },
    { title: 'Custom Industrial Machinery', description: 'Made-to-spec equipment for processing plants, facilities and manufacturing setups worldwide.', image: 'https://images.unsplash.com/photo-1607853554439-0069ec0f29b6?auto=format&fit=crop&w=1400&q=80', metrics: ['Design review', 'Project coordination', 'After-sales service'] },
  ]
              ...
              <Reveal key={category.title} delay={index * 0.08}>
                <div className="group overflow-hidden rounded-3xl border border-sky-200 bg-white shadow-sm">
                  <div className="relative aspect-[16/10] overflow-hidden">
                    <Image src={category.image} alt={category.title} fill sizes="(min-width:768px) 50vw, 100vw" className="object-cover transition-transform duration-&lsqb;1200ms&rsqb; group-hover:scale-105" />
