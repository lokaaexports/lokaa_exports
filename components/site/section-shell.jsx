...
export function SectionHeading({ eyebrow, title, description, align = 'left', actionHref, actionLabel, titleClassName = 'text-navy', descriptionClassName = 'text-graphite/70', eyebrowClassName = 'text-graphite/60', actionClassName = 'text-navy border-navy/30 hover:border-gold hover:text-gold' }) {
  return (
