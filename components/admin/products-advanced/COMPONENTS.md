...
import CategorySelector from '@/components/admin/products-advanced/CategorySelector'
import SubcategorySelector from '@/components/admin/products-advanced/SubcategorySelector'
import TemplateSelector from '@/components/admin/products-advanced/TemplateSelector'
import DynamicFormGenerator from '@/components/admin/products-advanced/DynamicFormGenerator'
import SpecificationBuilder from '@/components/admin/products-advanced/SpecificationBuilder'
import ImageUploader from '@/components/admin/products-advanced/ImageUploader'
...
export default function CreateProductPage() {
  ...
  const handleCreateProduct = async () => {
    try {
      const response = await fetch('/api/admin/products-advanced/products', {
        method: 'POST',
  ...
  const handlePublish = async () => {
    try {
      const response = await fetch(
        `/api/admin/products-advanced/products/${productId}?action=publish`,
        { method: 'POST' }
      )
      const data = await response.json()
...
| Component | Endpoints |
|-----------|-----------|
| CategorySelector | GET /api/admin/products-advanced/categories |
| SubcategorySelector | GET /api/admin/products-advanced/subcategories |
| TemplateSelector | GET /api/admin/products-advanced/templates |
| DynamicFormGenerator | GET /api/admin/products-advanced/template-fields |
| ProductList | GET/POST/PUT/DELETE /api/admin/products-advanced/products |
| SpecificationBuilder | GET/POST/PUT/DELETE /api/admin/products-advanced/specifications |
| ImageUploader | GET/POST/DELETE /api/admin/products-advanced/images |
