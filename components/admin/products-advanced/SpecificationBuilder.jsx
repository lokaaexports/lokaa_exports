...
export default function SpecificationBuilder({ 
  ...
  const fetchSpecifications = async () => {
    try {
      ...
      const response = await fetch(
        `/api/admin/products-advanced/specifications?productId=${productId}`
      )
  ...
  const handleAddSpec = async () => {
    ...
    try {
      const response = await fetch('/api/admin/products-advanced/specifications', {
        method: 'POST',
  ...
  const handleDeleteSpec = async (specId) => {
    ...
    try {
      const response = await fetch(
        `/api/admin/products-advanced/specifications/${specId}`,
        { method: 'DELETE' }
      )
      const data = await response.json()
