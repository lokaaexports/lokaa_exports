...
export default function ProductForm({ isOpen, onClose, onSubmit, product = null }: any) {
            ...
            <div className={`bg-white dark:bg-slate-800 rounded-xl shadow-2xl overflow-hidden ${
              ...
              <motion.div
                className={`sticky top-0 flex items-center justify-between p-4 ${
                  isCentered
                    ...
                    : 'bg-white dark:bg-slate-900 text-slate-900 dark:text-white border-b'
                } ${!isCentered ? 'cursor-grab active:cursor-grabbing' : 'cursor-default'} border-slate-200 dark:border-slate-800`}
              >
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-md bg-white dark:bg-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all ${
                    errors.name ? 'border-red-500' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600'
                  }`}
                />
              ...
              <div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full px-3 py-2 border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-md text-slate-600 dark:text-slate-400 hover:border-blue-500 dark:hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors"
                >
                  + Upload Images
                </motion.button>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex-1 px-4 py-2 bg-slate-900 dark:bg-white hover:bg-slate-800 dark:hover:bg-slate-100 text-white dark:text-slate-900 rounded-md font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                >
