          ...
          <Card className="mt-6 border border-navy/10 bg-white shadow-[0_14px_40px_rgba(15,23,42,0.06)]">
            ...
            <CardContent className="space-y-4 pt-6">
              {[
                ...
                <div key={id} className="flex items-start gap-4 rounded-2xl border border-navy/10 bg-ivory p-4">
                  <input type="checkbox" id={id} className="mt-1 h-4 w-4 rounded border-slate-300 accent-[#1a472a]" defaultChecked={checked} />
