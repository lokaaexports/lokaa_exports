...
import { safeParseInt, sanitizeSearch, whitelistStatus, customerStatusWhitelist } from '@/lib/sanitize'
...
export async function GET(request: any) {
  try {
    ...
    const country = sanitizeSearch(searchParams.get('country'))
    const status = whitelistStatus(searchParams.get('status'), customerStatusWhitelist)
