...
export async function GET(request) {
  try {
    ...
    return NextResponse.json({ error: error.message || 'Unable to load RBAC data' }, { status: 500 })
  }
}
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json({ error: error.message || 'Unable to create RBAC record' }, { status: 500 })
  }
}
...
export async function PUT(request) {
  try {
    ...
    return NextResponse.json({ error: error.message || 'Unable to update RBAC record' }, { status: 500 })
  }
}
...
export async function DELETE(request) {
  try {
    ...
    return NextResponse.json({ error: error.message || 'Unable to delete RBAC record' }, { status: 500 })
  }
}
